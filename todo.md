...
| 5.2 | Step 1 — PassageStep（课文展示 + AI 配图 + 逐句朗读 + 词汇卡片 + 下一步按钮） | 5.1 | ✅ |
| 5.3 | Step 1 — SentencePlayer 逐句朗读（暂停/继续/停止） | 2.2, 5.2 | ✅ |
| 5.4 | Step 1 — GrammarCard 语法点卡片 | 5.2 | ✅ |
| 5.4a | Step 1 — VocabularyCard 词汇卡片（词 + 音标 + 释义） | 5.2 | ✅ |
...
| # | 任务 | 依赖 | 状态 |
|---|------|------|:--:|
| 7.1 | SettingsScreen — TTS 语速选择（0.75×/1.0×/1.25×/1.5×），DataStore 持久化 | 1.8 | ✅ |
